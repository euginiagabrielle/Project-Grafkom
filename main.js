...
function main() {
  ...
  //gl_FragColor = vec4(1.,1.,1.,1.);\n\
    ...
    var speaker = new MyObject("speaker", [], [], shader_vertex_source, shader_fragment_source);
    var speaker1_vertex = [ 
        -6, -0.87, 5,     0.1, 0.1, 0.1,
        -9, -0.87, 5,     0.1, 0.1, 0.1,
        -9, 1, 5,     0.1, 0.1, 0.1,
        -6, 1, 5,     0.1, 0.1, 0.1,
 
        -9, -0.87, 4,     0.1, 0.1, 0.1,
        -6, -0.87, 4,     0.1, 0.1, 0.1,
        -9, 1, 4,     0.1, 0.1, 0.1,
        -6, 1, 4,     0.1, 0.1, 0.1,
    ...
    var speaker1 = new MyObject("speaker1", speaker1_vertex, speaker1_faces, shader_vertex_source, shader_fragment_source);
    speaker.addChild(speaker1);
    ...
    var speaker2 = new MyObject("speaker2", speaker2_vertex, speaker2_faces, shader_vertex_source, shader_fragment_source);
    speaker.addChild(speaker2);


    var lampu = new MyObject("lampu", [], [], shader_vertex_source, shader_fragment_source);
    var lampu1_vertex = [ 

        -10.95,0.5,-3, 0.95, 0.76, 0.18,
        -11.45,0.5,-3, 0.95, 0.76, 0.18,
        -10.95,0.5,-3.5, 0.95, 0.76, 0.18,
        -11.45,0.5,-3.5, 0.95, 0.76, 0.18,

        -10.95,-0.75,-3, 0.95, 0.76, 0.18,
        -11.45,-0.75,-3, 0.95, 0.76, 0.18,
        -10.95,-0.75,-3.5, 0.95, 0.76, 0.18,
        -11.45,-0.75,-3.5, 0.95, 0.76, 0.18,
    ...
    var lampu1 = new MyObject("lampu1", lampu1_vertex, lampu1_faces, shader_vertex_source, shader_fragment_source);
    lampu.addChild(lampu1);
    lampu1.translate=[-0.5,-0.005,-1.4];
    ...
    var lampu2 = new MyObject("lampu2", lampu2_vertex, lampu2_faces, shader_vertex_source, shader_fragment_source);
    lampu.addChild(lampu2);
    lampu2.translate=[22.8,-0.005,-1.4];
    //...
    //env end
    ...
    var animate = function (time) {
        ...
        speaker.setuniformmatrix4(PROJMATRIX, VIEWMATRIX);
        speaker.draw();
        speaker.setIdentityMove();
        speaker.setRotateMove(0,0,0);

        lampu.setuniformmatrix4(PROJMATRIX, VIEWMATRIX);
        lampu.draw();
        lampu.setIdentityMove();
        lampu.setRotateMove(0,0,0);
        //...
        //env end

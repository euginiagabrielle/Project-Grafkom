...
function main() {
    ...
    var animate = function (time) {
        if (time > 0) {
            ...
            //     yeDee.setTranslateMove(0.05,0,0);
            //     yeDee.setRotateMove(LIBS.radToDeg(PHI), LIBS.radToDeg(THETA), 0);
            // }
            // let x0 = yeDee.translate[0];
            // let y0 = yeDee.translate[1];
            // let z0 = yeDee.translate[2];
            // yeDee.setTranslateMove(-x0,-y0,-z0);
            yeDee.setRotateMove(LIBS.radToDeg(PHI), LIBS.radToDeg(THETA), 0);
            // yeDee.setTranslateMove(x0,y0,z0);
            
            // console.log(telinga.scale[0]);
            if (membesar) {
